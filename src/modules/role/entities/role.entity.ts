...
import {
    ...
    UpdateDateColumn,     // Crea una columna que se actualiza automáticamente en cada modificación.
} from "typeorm";

// Define la clase como una entidad que representará la tabla "roles".
@Entity("roles")
export class RoleEntity extends BaseEntity { // Hereda de BaseEntity para usar métodos ORM.
